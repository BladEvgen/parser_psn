...
file_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "url", "url_2.txt")
...
async def process_url(url):
    try:
        ...
        if json["data"]["productRetrieve"] is not None:
            title = json["data"]["productRetrieve"]["name"]
            price = json["data"]["productRetrieve"]["skus"][-1]["displayPrice"]
